...
public class ThumbnailUriTestCase extends TestCase {
    public void testConstructFromCompleteUrl() throws Exception {
        String url = HttpThumbnailDownloader.ThumbnailUrl.construct("http://www.radio-t.com/thumbnail.jpg");
        assertEquals("http://www.radio-t.com/thumbnail.jpg", url);
    }

    public void testConstructFromRelativeUrl() throws Exception {
        String url = HttpThumbnailDownloader.ThumbnailUrl.construct("/thumbnail.jpg");
        assertEquals("http://www.radio-t.com/thumbnail.jpg", url);
    }

    public void testNoUrl() throws Exception {
        assertNull(HttpThumbnailDownloader.ThumbnailUrl.construct(null));
    }
}
